...
class MainPanel extends Component {
    ...
    render() {
        return (
            <div className="container bg-dark main-panel">
                ...
                <div className="row justify-content-center play-area">
                    <div className="col-sm-12 col-lg-8">
                        <PlayArea playerVal={this.state.playerVal} compVal={this.state.compVal} batting={this.state.batting}/>
                    </div>
                ...
                <div className="row justify-content-center no-gutters">
                    <div className="col-sm-12 col-md-8 bg-dark align-self-end">
